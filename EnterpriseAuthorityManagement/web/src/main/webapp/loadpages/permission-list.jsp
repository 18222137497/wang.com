						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/loadpages/permission-add.jsp'">
							...
							<table id="dataList"
								...
								<tbody class="box-tools">
									...
									<c:forEach items="${permissionFindAll}" var="p">
										<tr>
